#before you run the script put in the terminal : pip3 install requests colorama pysocks
import socks 
import socket 
import requests 
import threading 
...
print(Fore.RED + "Code By black-hat-rgb")
print(" ")
print("Version 2.0  https://github.com/black-hat-rgb/Ddos-scripts\n") 

time.sleep(1)
print (Fore.BLUE+"> BLACK HAT RGB")
time.sleep(1)
print (Fore.BLUE+"> Current build: 2.0")
time.sleep(3)
print (Fore.GREEN+"> Coded by black-hat-rgb")
time.sleep(2)
print (Fore.BLUE+"> BLACK HAT RGB")
